...
version = "1.1.0"
description = "Korean Lunisolar Calendar"
...
tasks.jar {
	manifest {
		attributes(mapOf(
				...
				"Automatic-Module-Name" to "com.elex_project.pheonix"
		))
	}
}
...
publishing {
	publications {
		create<MavenPublication>("mavenJava") {
			...
			pom {
				...
				url.set("https://github.com/elex-project/pheonix")
				organization {
				...
				licenses {
					license {
						...
						url.set("https://github.com/elex-project/pheonix/blob/main/LICENSE")
					}
				}
				developers {
					developer {
				...
				scm {
					connection.set("scm:git:https://github.com/elex-project/pheonix.git")
					developerConnection.set("scm:git:https://github.com/elex-project/pheonix.git")
					url.set("https://github.com/elex-project/pheonix")
				}
			}
		}
	...
	repositories {
		...
		maven { 
			name = "mavenGithub"
			url = uri("https://maven.pkg.github.com/elex-project/pheonix")
			credentials {
